...
class Todo extends Component {
        ...
        setTimeout(() => {
            if (this.state.form.id) {
                ...
                const index = todos.findIndex(
                    (todo) => todo.id === this.state.form.id
                );
                const todo = {
                    ...this.state.form,
                };
    ...
    handleDelete = (id) => {
        if (!confirm(`Apakah anda yakin ingin menghapus tugas ini ${id}? `))
            return;
        ...
        return (
            <div className="container-fluid pt-4 px-4 position-relative">
                ...
                <div
                    ...
                    } toast position-absolute top-0 end-0 me-4 mt-4 align-items-center text-bg-primary border-0`}
                    role="alert"
                    aria-live="assertive"
                    aria-atomic="true"
                >
                ...
                {(this.props.isLoading && <LoadingAnimation />) || (
                    <TodoList
                        handleSelectedTodoForEdit={
                            this.handleSelectedTodoForEdit
                        }
...
connectDummy(console.log, console.log);

const TodoComponentWithPropsFromRedux = connect(
    mapStateToProps,
    null
)(TodoComponent);

export default TodoComponentWithPropsFromRedux;
